...
public class QuestionPicker {
    ...
    public static void pickQuestionsSimple(int n, PatternCreator patternCreator, String... words) {
    ...
    public static void pickQuestionsStructure(int n, PatternCreator patternCreator, String verb, List<String> structure1, String noun1,
